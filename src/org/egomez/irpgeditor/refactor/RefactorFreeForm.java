...
public class RefactorFreeForm extends Refactor {
  ...
  public void process(SourceLine line) {
    ...
    if ( op.equalsIgnoreCase("IF") || op.equalsIgnoreCase("DOU") || op.equalsIgnoreCase("DOW") ) {
    ...
    else if ( op.equalsIgnoreCase("END") || op.equalsIgnoreCase("ENDIF") || op.equalsIgnoreCase("ENDDO") || op.equalsIgnoreCase("ENDSR") ) {
      backTab(bufferTab);
      ...
      line.setText(before + bufferTab + op + " " + (line.get(LinePosition.C_FACTOR_1) + " " + line.get(LinePosition.C_FACTOR_2)).trim() + line.get(LinePosition.C_RESULT) + ";\n");
    }
    else if ( op.equalsIgnoreCase("MOVE") || op.equalsIgnoreCase("Z-ADD")  || op.equalsIgnoreCase("MOVEL") ) {
      line.setText(before + bufferTab + line.get(LinePosition.C_RESULT) + " = " + line.get(LinePosition.C_FACTOR_2) + ";\n");
    }
    ...
    else if ( op.equalsIgnoreCase("READE") || op.equalsIgnoreCase("READE(N)") || 
              op.equalsIgnoreCase("READ") || op.equalsIgnoreCase("READ(N)") ||
              op.equalsIgnoreCase("READP") || op.equalsIgnoreCase("READP(N)") ||
      ...
      // if there is no op, then this line is proably a continuation of the previous if/dou/dow line.
      if ( op.trim().length() == 0 ) {
  ...
  private String processIndicators(SourceLine line, String op) {
    ...
    bufferTab.append("  ");
    // if this indicator is placed onto a start of a block of code, then then endif
