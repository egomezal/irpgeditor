...
/**
 * A group of source members.
 * A list of run configurations.
 *
...
public class Project extends NodeAbstract {
  ...
  /**
   * Removes an object from the  list of objects that will be notified of events that
   * this object produces.
   * 
   * @param listener ListenerProject
   */
  ...
  /**
   * gets called when a member is added to this project.
   * notifies listeners that a member was added to the project.
   * 
   * @param member Member
   */
  ...
  /**
   * gets called when a member is removed from this project.
   * notifies listeners that a member was removed from the project.
   * 
   * @param member Member
   */
