...
public class SourceLine {
  ...
  /**
   * treats this line like a procedure, and gets the text that would be considered its name.
   */
  ...
  /**
   * treats this line like a screen, and gets the text that would be considered its name.
   */
