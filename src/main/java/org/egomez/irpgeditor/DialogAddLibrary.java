...
public class DialogAddLibrary extends JDialog {
    ...
    DefaultComboBoxModel<String> listModelFiles = new DefaultComboBoxModel<>();

    DefaultComboBoxModel<String> listModelLibraries = new DefaultComboBoxModel<>();

    DefaultComboBoxModel<AS400System> listModelSystems = new DefaultComboBoxModel<>();
    JPanel panel1 = new JPanel();

    VerticalFlowLayout verticalFlowLayout4 = new VerticalFlowLayout();

    JComboBox<String> comboboxLibrary = new JComboBox<>(this.listModelLibraries);

    JComboBox<AS400System> comboboxSystem = new JComboBox<>(this.listModelSystems);
    ...
    private final JComboBox<String> comboBox = new JComboBox<>(this.listModelLibraries);
    ...
    void jbInit() throws Exception {
        ...
        comboboxType.addActionListener((ActionEvent e) -> {
