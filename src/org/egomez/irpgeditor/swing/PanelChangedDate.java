...
/**
 * This panel is displayed on the right side of the source code. It displays
 * a date for each line of code. The date displayed is the date at which the
 * line was either created or last changed. If the line has been modified in the
 * source editor then the date will show up blue with the current date. If
 * the line is a new line of code then a number 0 will be displayed for the line
 * in the color green.
 * 
...
public class PanelChangedDate extends JPanel implements ChangeListener {
  ...
  /**
   * when you set the scrollpane this control will listen to 
   * change events that the scrollpane generates.
   * 
