...
public class PanelSQLPlus extends PanelTool implements ListenerAS400Systems,
    ...
    public PanelSQLPlus() {
        ...
        btnSQL.addActionListener((ActionEvent e) -> {
        ...
        mntmExportToExcel.addActionListener((ActionEvent e) -> {
            JFileChooser dlgArchivo = new JFileChooser();
            dlgArchivo.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
            dlgArchivo.setDialogTitle("Save File");
            dlgArchivo.setDialogType(JFileChooser.SAVE_DIALOG);
                    ...
                    try {
                        ...
                        switch (exportType) {
                            case QUERY_EXPORT_TEXT:
                                ...
                                String cadena = "";
                                for (i1 = 1; i1 <= c; i1++) {
                                    cadena = cadena + rmd.getColumnName(i1)
                                            + (char) 9;
                                }
                                salida.write(cadena);
                                salida.newLine();
                            ...
                            case QUERY_EXPORT_EXCEL:
                                ...
                                WritableCellFormat integerFormat;
                                ...
                                for (i1 = 1; i1 <= nColumn; i1++) {
                                    label = new Label(i1 - 1, 0,
                                            rmd.getColumnName(i1));
                                    sheet.addCell(label);
                                }
                                k = 0;
                                i1 = 0;
